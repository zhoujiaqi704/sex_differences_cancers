...
dmpTable_LUSC_permutation1000=list(permuted_pval_female=permuted_pval_female, permuted_beta_female=permuted_beta_female, 
	permuted_pval_male=permuted_pval_male, permuted_beta_male=permuted_beta_male)
	
save(dmpTable_LUSC_permutation1000, file="./TCGA_LUSC/dmpTable_LUSC_permutation1000.rda")

##compare bonf

#calculate the bonf
permuted_bonf_female=as.data.frame(matrix(NA,nrow=nrow(dmpTable_LUSC_permutation1000$permuted_pval_female), ncol=1000),row.names=rownames(dmpTable_LUSC_permutation1000$permuted_pval_female))
permuted_bonf_male=as.data.frame(matrix(NA,nrow=nrow(dmpTable_LUSC_permutation1000$permuted_pval_female), ncol=1000),row.names=rownames(dmpTable_LUSC_permutation1000$permuted_pval_female))
